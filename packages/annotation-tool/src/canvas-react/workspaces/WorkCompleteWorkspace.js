...
import PolylinesCanvas from "../layers/polylines";
import PolylineSelectionsCanvas from "../layers/polylineSelections";
...
class WorkCompleteWorkspace {
	constructor() {
		this.layers = [
			new PolylinesCanvas(),
			new PolylineSelectionsCanvas(),
		]
	...
	onUndo = () => this.layers.find(layer => layer.onUndo()) 
	onRedo = () => this.layers.find(layer => layer.onRedo()) 
...
export default WorkCompleteWorkspace
